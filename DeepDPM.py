...
if __name__ == "__main__":
    #python DeepDPM.py --dataset MNIST --dir "./pretrained_embeddings/umap_embedded_datasets/MNIST" --use_labels_for_eval --save_checkpoints
    #python DeepDPM.py --dataset USPS --dir "./pretrained_embeddings/umap_embedded_datasets/USPS" --use_labels_for_eval --save_checkpoints True --max_epochs 700
    #python DeepDPM.py --dataset FASHION --dir "./pretrained_embeddings/umap_embedded_datasets/FASHION" --use_labels_for_eval --save_checkpoints True


    print(datetime.datetime.now())
    net_pred=train_cluster_net()
    print(datetime.datetime.now())
